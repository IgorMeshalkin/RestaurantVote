...
VALUES (1, 'admin', '$2a$12$sJRGxiMBj0S9bocY/aOkvurjsLwm.877ncQIe2zgcWOCeQItzQRuq', 'Игорь', 'Мешалкин', 'ADMIN', current_timestamp(), current_timestamp(), true),
       (2, 'ivan', '$2a$12$2vOTh3/CyvRgC1xDRg2/2.C0.pxzuwEgD0K91.cTQ1wIkmeowNuWu', 'Иван', 'Иванов', 'USER', current_timestamp(), current_timestamp(), true),
       (3, 'petr', '$2a$12$Kbst4hU./lWV3LY36dI./uKnAtTBk0EBlGgVlKuu46g.GFuD7kf4S', 'Петр', 'Петров', 'USER', current_timestamp(), current_timestamp(), true);

INSERT restaurants(id, name, created, updated)
VALUES
    (1, 'Subway', current_timestamp(), current_timestamp()),
...
ALTER TABLE restaurants AUTO_INCREMENT = 4;
ALTER TABLE meals AUTO_INCREMENT = 7;
